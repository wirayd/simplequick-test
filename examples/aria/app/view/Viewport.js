            ...
            items: [{
                ...
                items: [{
                    ...
                    handler: function() {
                        ...
                        // There is a known issue with focusing freshly created input elements
                        // in IE10, with IE8 being especially notorious. This is a workaround
                        // for the issue.
                        if (Ext.isIE8) {
                            var target = win.getDefaultFocus();
                            
                            if (target) {
                                target.focus(false, 20);
                            }
                        }
                    }
                }]
