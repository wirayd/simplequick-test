describe("Ext.util.FocusableContainer", function() {
    ...
    describe("init/destroy", function() {
        ...
        describe("enableFocusableContainer === false", function() {
            ...
            it("should not alter tabIndex on added child", function() {
                fc.add({ xtype: 'button', text: 'foo' });
                
                var btn = fc.down('button[text=foo]');
                
                expect(btn.el.dom.getAttribute('tabIndex')).toBe('0');
            });
    ...
    describe("focus handling", function() {
        ...
        describe("enableFocusableContainer === false", function() {
            ...
            it("should not activate fcEl on focusleave", function() {
                ...
                runs(function() {
                    expect(fc.el.dom.hasAttribute('tabIndex')).toBe(false);
                });
            });
        });
