                ...
                function expectPosition(dock, expectedIndex) {
                    ...
                    if (!dock) {
                        if (withLocking) {
                            ...
                            parentNode = expectedIndex === -1
                                ? lockedView.getNodeContainer()
                                : lockedView.getRow(expectedIndex).parentNode;
                        ...
                        parentNode = expectedIndex === -1
                            ? theView.getNodeContainer()
                            : theView.getRow(expectedIndex).parentNode;
