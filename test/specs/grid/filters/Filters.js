        ...
        describe("autoLoad", function () {
            describe("if true", function () {
                ...
                it("should not load the store again when expanding the headerCt menu", function() {
                    ...
                    // here we need waits because we are waiting for something NOT to happen
                    waits(200);
            ...
            describe("if false", function() {
                it("should not cause the store to load", function () {
                    ...
                    spyOn(proto, 'attemptLoad').andCallThrough();
                    ...
                    expect(proto.attemptLoad).not.toHaveBeenCalled();
                });
            });
